const t=`{
	...
	"actions": {
		...
		"saveFile": { "name": "\u4FDD\u5B58\u6587\u4EF6", "description": "\u4FDD\u5B58\u5F53\u524D\u6253\u5F00\u7684\u6587\u4EF6" },
		"saveAs": {
			"name": "\u53E6\u5B58\u4E3A",
		...
		"settings": { "name": "\u8BBE\u7F6E", "description": "\u6253\u5F00bridge.\u7684\u5E94\u7528\u8BBE\u7F6E" },
		"extensions": {
			"name": "\u6269\u5C55",
			"description": "\u5B89\u88C5\u548C\u7BA1\u7406\u5DF2\u5B89\u88C5\u7684\u6269\u5C55"
		},
		"copy": { "name": "\u590D\u5236", "description": "\u5C06\u9009\u5B9A\u7684\u6587\u672C\u590D\u5236\u5230\u526A\u8D34\u677F" },
		"cut": {
			"name": "\u526A\u5207",
			"description": "\u5C06\u9009\u5B9A\u7684\u6587\u672C\u590D\u5236\u5230\u526A\u8D34\u677F\u5E76\u5C06\u5176\u4ECE\u539F\u59CB\u4E0A\u4E0B\u6587\u4E2D\u5220\u9664"
		},
		"paste": { "name": "\u7C98\u8D34", "description": "\u7C98\u8D34\u526A\u8D34\u677F\u5185\u5BB9" },
		"docs": { "name": "\u6587\u6863", "description": "\u6253\u5F00Minecraft\u9644\u52A0\u5305\u6587\u6863" },
		"releases": {
			"name": "\u53D1\u5E03\u7248\u672C",
		...
		"closeTab": { "name": "\u5173\u95ED\u6807\u7B7E\u9875", "description": "\u5173\u95ED\u6B64\u6807\u7B7E\u9875" },
		"closeAll": { "name": "\u5173\u95ED\u5168\u90E8", "description": "\u5173\u95ED\u5168\u90E8\u6807\u7B7E\u9875" },
		"closeTabsToRight": {
			"name": "\u5173\u95ED\u53F3\u4FA7\u7684\u6807\u7B7E\u9875",
		...
		"undo": { "name": "\u64A4\u9500", "description": "\u64A4\u6D88\u6700\u540E\u4E00\u6B21\u64CD\u4F5C" },
		"redo": { "name": "\u91CD\u505A", "description": "\u91CD\u505A\u6700\u540E\u4E00\u6B21\u64CD\u4F5C" },
		"goToDefinition": {
			"name": "\u8F6C\u5230\u5B9A\u4E49",
		...
		"tgaMaskToggle": { "name": "\u663E\u793A/\u9690\u85CFAlpha\u8499\u7248" },
		"recompileChanges": {
			"name": "\u7F16\u8BD1\u66F4\u6539",
	...
	"toolbar": {
		"project": { "name": "\u9879\u76EE" },
		"file": { "name": "\u6587\u4EF6", "preferences": { "name": "\u9996\u9009\u9879" } },
		"edit": { "name": "\u7F16\u8F91" },
		"tools": { "name": "\u5DE5\u5177" },
		"help": { "name": "\u5E2E\u52A9" }
	},
	"sidebar": {
		"compiler": {
			...
			"actions": { "runLastProfile": "\u8FD0\u884C\u6700\u540E\u4E00\u6B21\u7684\u914D\u7F6E\u6587\u4EF6" }
		},
		"extensions": { "name": "\u6269\u5C55" },
		"notifications": {
			"socials": { "message": "\u793E\u4EA4\u5A92\u4F53" },
			"gettingStarted": { "message": "\u65B0\u624B\u5165\u95E8" },
			"installApp": { "message": "\u5B89\u88C5\u5E94\u7528" },
			"updateAvailable": { "message": "\u53EF\u7528\u66F4\u65B0" },
	...
	"windows": {
		"sidebar": { "disabledItem": "\u8BE5\u9879\u5DF2\u7981\u7528" },
		"changelogWindow": { "title": "\u6709\u4F55\u65B0\u5185\u5BB9\uFF1F" },
		"openFile": {
			"title": "\u6253\u5F00",
			"search": "\u641C\u7D22\u6587\u4EF6...",
			"noData": "\u6CA1\u6709\u7ED3\u679C..."
		...
		"packExplorer": {
			...
			"exportAsMcaddon": { "name": "\u5BFC\u51FA\u4E3A.mcaddon" },
			"exportAsMctemplate": {
				"name": "\u5BFC\u51FA\u4E3A.mctemplate",
				"chooseWorld": "\u9009\u62E9\u4E00\u4E2A\u4E16\u754C"
			},
			...
			"exportAsBrproject": { "name": "\u5BFC\u51FA\u4E3A.brproject" },
			"fileActions": {
				"open": { "name": "\u6253\u5F00", "description": "\u5728\u7F16\u8F91\u5668\u4E2D\u6253\u5F00\u6587\u4EF6" },
				"openInSplitScreen": {
					"name": "\u5728\u5206\u5C4F\u4E2D\u6253\u5F00",
				...
				"rename": { "name": "\u91CD\u547D\u540D", "description": "\u91CD\u547D\u540D\u4E00\u4E2A\u6587\u4EF6" },
				"duplicate": { "name": "\u590D\u5236", "description": "\u590D\u5236\u4E00\u4E2A\u6587\u4EF6" },
				"viewCompilerOutput": {
					"name": "\u67E5\u770B\u7F16\u8BD1\u5668\u8F93\u51FA",
		...
		"pluginInstallLocation": { "title": "\u9009\u62E9\u5B89\u88C5\u4F4D\u7F6E" },
		"unsavedFile": {
		...
		"loadingWindow": { "titles": { "loading": "\u6B63\u5728\u52A0\u8F7D..." } },
		"upgradeFs": {
			"title": "\u5347\u7EA7\u6587\u4EF6\u7CFB\u7EDF\uFF1F",
	...
	"functionValidator": {
		...
		"errors": {
			...
			"identifiers": { "missingNamespace": "\u6807\u8BC6\u7B26\u4E2D\u7F3A\u5C11\u547D\u540D\u7A7A\u95F4\uFF01" },
			"ranges": {
